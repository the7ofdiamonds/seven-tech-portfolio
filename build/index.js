...
const getPortfolio = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('portfolio/getPortfolio', async () => {
  try {
...
const getProjectsType = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('portfolio/getProjectsType', async projectType => {
  try {
...
const getProjectsTag = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('portfolio/getProjectsTag', async projectTag => {
  try {
...
const getPortfolioTypes = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('portfolio/getPortfolioTypes', async () => {
  try {
...
const getPortfolioTags = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('portfolio/getPortfolioTags', async () => {
  try {
...
const portfolioSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  name: 'portfolio',
  initialState,
  extraReducers: builder => {
...
/* harmony default export */ __webpack_exports__["default"] = (portfolioSlice);
...
const initialState = {
  ...
  logo: '',
  colors: [{
    title: 'colors_primary',
    value: '#000000'
  }, {
    title: 'colors_secondary',
    value: '#000000'
  }, {
    title: 'colors_tertiary',
    value: '#000000'
  }],
  plan: '',
  onboardingID: '',
...
const getProjectOnboarding = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createAsyncThunk)('projectOnboarding/getProjectOnboarding', async (formData, {
  getState
}) => {
  try {
    const {
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "seven-tech-portfolio:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkseven_tech_portfolio"] = self["webpackChunkseven_tech_portfolio"] || [];
...
if (portfolio) {
  react_dom__WEBPACK_IMPORTED_MODULE_2___default().createRoot(portfolio).render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react__WEBPACK_IMPORTED_MODULE_1___default().StrictMode), null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_redux__WEBPACK_IMPORTED_MODULE_4__.Provider, {
